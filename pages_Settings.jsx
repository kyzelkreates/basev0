...
function ProgrammePanel() {
  ...
  return (
    <div>
      ...
      <SettingRow label="Default Weekly Target Hours" sub="Applied to all new participants. Individual targets can be overridden per participant.">
      ...
      <SettingRow label="Check-in Frequency" sub="How often participants should complete a check-in">
      ...
      <SettingRow label="Evidence Required" sub="Flag participants who have not uploaded supporting evidence">
        ...
        {isDemoMode ? (
          <div className="px-3 py-2.5 rounded-lg bg-amber-900/15 border border-amber-700/30">
            <p className="text-xs text-amber-300/80 leading-relaxed">
              <strong>Demo Mode is ON.</strong> Sample participants and activity data are visible throughout the dashboard and PWA. All demo records are clearly marked [DEMO]. Turn off to switch to real data mode.
            </p>
          </div>
        ) : (
          <div className="px-3 py-2.5 rounded-lg bg-emerald-900/15 border border-emerald-700/30">
            <p className="text-xs text-emerald-300/80 leading-relaxed">
              <strong>Demo Mode is OFF.</strong> Only real data is shown. The dashboard will show empty states until real participants and activity are added.
            </p>
          </div>
        )}
...
function ProfilePanel() {
  ...
  return (
    <div>
      <SectionHead label="Admin / Mentor Profile"/>
...
function AIPanel() {
  ...
  return (
    <div>
      <SectionHead label="4P3X 4P3X Base Intelligence Layer™"/>

      <SettingRow label="AI Mode" sub="Controls how 4P3X Intelligent AI works">
