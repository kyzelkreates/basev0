        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
          ...
          {section === 'driver' && (
            <>
              ...
              <InfoBox color="amber" icon="AlertTriangle">
                GB law: digital tachograph must be calibrated every 2 years. Driver CPC card expires every 5 years (weekly targets periodic training). Both are O-licence conditions.
              </InfoBox>
              <div className="grid grid-cols-2 gap-3">
