...
function CheckInModal({ participants, onClose, onSaved }) {
...
export default function CheckIns() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-5">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-800/60">
                  {['Participant','Date','Hours','Confidence','Support Needed','Barriers','Notes'].map(h => (
      ...
      {modal && <CheckInModal participants={participants} onClose={() => setModal(false)} onSaved={() => {}}/>}
    </div>
  )
}
