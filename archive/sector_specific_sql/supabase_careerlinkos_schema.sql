-- 4P3X Learning & Monitoring Base OS™ — SQL Schema
-- 4P3X Base OS™ — Supabase Schema
...
VALUES (
  ...
  '4P3X Base Demo Organisation',
  'Restart Scheme',
  'demo@4p3xbaseos.example'
