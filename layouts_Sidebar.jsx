...
function 4P3X BaseLogo({ onClose }) {
  return (
    <div className="flex items-center justify-between px-4 py-4 border-b border-[#2a1f00]/60">
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          <div className="font-display font-bold text-white text-sm leading-tight">4P3X Learning & Monitoring Base OS™</div>
...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Admin Monitoring Dashboard quick-access shortcut */}
      <div className="px-3 pb-2 space-y-2">
        ...
        >
          ...
          <span className="text-xs font-bold text-[#d4af37] flex-1 text-left">Admin Monitoring Dashboard</span>
        ...
        >
          ...
          <span className="text-xs font-medium text-slate-500 flex-1 text-left">Invite Participant</span>
